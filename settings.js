...
SESSION_ID: process.env.SESSION_ID || "PFoE0DTJ#VUSMBEbzhh4kGkTdgswkK_u-b6PVv0Fq2ig6uy4WKt0", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "18293125805",
DEV: process.env.DEV || "18293125805",
